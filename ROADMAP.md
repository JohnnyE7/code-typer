...
- Continue frontend decomposition: split remaining `main.js` responsibilities into focused modules for completion flow.
...
- Frontend decomposition: extracted typing input normalization and IDE auto-pair handling into `frontend/src/typing.js`.
